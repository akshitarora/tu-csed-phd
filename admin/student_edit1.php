  ...
  <section class="wrapper">
    <div id="row">
      ...
      <ol class="breadcrumb">
        ...
        <li><i class="icon_document_alt"></i><a href="student_edit1.php">Edit Student</a></li>
      </ol>
    </div>
    <div class="row">
      <section class="panel">
        <header class="panel-heading">
                ...
                <div class="panel-body">
                  <div class="form">
                      <form class="form-validate form-horizontal" method="post" action="student_edit2.php">
                      <div class="form-group">
                        <label for="old_student" class="control-label col-lg-2">Student to be edited<span class="required">*</span></label>
                        <div class="col-lg-10">
