      ...
      <section class="panel">
        <header class="panel-heading">
                ...
                <div class="panel-body">
                  <div class="form">
                    <form class="form-validate form-horizontal" method="post" action="department_deleteprocess.php">
                    <div class="form-group">
                                          <label for="sbranch" class="control-label col-lg-2">Department to be deleted<span class="required">*</span></label>
                                          <div class="col-lg-10">
                                              ...
                                              <select name="sbranch">
                                                  ...
                                                  while($rowdept = mysqli_fetch_array($resultdept,MYSQL_ASSOC)) {
                                                    ...
                                                    echo $rowdept["dpt_name"].' ('.$rowdept["dpt_code"].')'; echo "</option>";
                                                  }
                                                  ?>
                                              </select>
                                          </div>
